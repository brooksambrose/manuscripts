...
```{r,t-paradigm,eval=T,results='asis'}
cat(readLines(paste0(tab,'paradigm.txt')),sep='\n')
```
...
###Teleology
Not all of the things people "do" are `r one(2)` in this sense. Teleological `r one(2)` have a goal or end known to the `r ones(1)`
